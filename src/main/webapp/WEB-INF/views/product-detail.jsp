...
<div class="container mt-3">
    <form action="/product/update" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="mb-3">
            <fmt:formatDate value="${product.createdAt}" pattern="yyyy-MM-dd HH:mm" var="formattedDate" />
            <input type="text" class="form-control" value="${formattedDate}" name="createdAt" disabled>
        </div>
